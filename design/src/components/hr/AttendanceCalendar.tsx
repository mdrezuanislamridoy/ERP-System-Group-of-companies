      ...
      {showSummary && (
        <div className="rounded-xl border border-line bg-canvas p-4">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-2.5">
            {[
              { label: 'Present', value: summary.present, color: 'text-emerald-600', bg: 'bg-emerald-500/10' },
              { label: 'Late', value: summary.late, color: 'text-amber-600', bg: 'bg-amber-500/10' },
              { label: 'Absent', value: summary.absent, color: 'text-rose-600', bg: 'bg-rose-500/10' },
              { label: 'On Leave', value: summary.onLeave, color: 'text-blue-600', bg: 'bg-blue-500/10' },
              { label: 'Half Day', value: summary.halfDay, color: 'text-violet-600', bg: 'bg-violet-500/10' },
              { label: 'Holidays', value: summary.holidays, color: 'text-indigo-600', bg: 'bg-indigo-500/10' },
